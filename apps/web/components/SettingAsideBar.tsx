  ...
  return (
    <div className="bg-[#F1F5F9] dark:bg-[#0F172A] rounded-2xl shadow-md overflow-hidden max-w-sm mx-auto p-4 w-[290px] h-[300px]">
      ...
      <Button
        ...
        className="border-[1px] border-gray-600 px-4 py-2 rounded-sm bg-[#4E7AFF] text-white w-[257px] h-[40px]"
      >
        <LogOut size={16} />
        Logout
      </Button>
